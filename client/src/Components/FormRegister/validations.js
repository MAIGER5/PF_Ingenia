...
export function validationClient(inputs) {
  ...
  if (inputs.password.length < 8 || inputs.password.length > 10)
...
export function validationVendor(inputs) {
  ...
  if (inputs.studies.length < 80)
    errors.studies = "Ingresa mínimo 80 caracteres";

  if (inputs.studies.length > 250)
    errors.studies = "Hay un máximo de 250 caracteres.";

  if (inputs.description.length < 100)
    errors.description = "Ingresa mínimo 100 caracteres";

  if (inputs.description.length > 250)
    errors.description = "Hay un máximo de 250 caracteres.";
