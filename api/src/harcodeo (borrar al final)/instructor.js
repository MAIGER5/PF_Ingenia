[
  {
    ...
    studies:
      "200-hour RYT certification from Yoga Alliance, advanced training in Hatha and Vinyasa yoga.",
    asset: true,
  },
  {
    idInstructor: 2,
    ...
    studies:
      "Bachelor's degree in Exercise Science, ACE certified personal trainer.",
    asset: false,
  },
  {
    idInstructor: 3,
    ...
    studies:
      "Bachelor's degree in Dance from London Contemporary Dance School, additional training in ballet from Royal Ballet School and contemporary dance from Hong Kong Academy for Performing Arts.",
    asset: true,
  },
  {
    idInstructor: 4,
    ...
    studies:
      "Culinary arts degree from Le Cordon Bleu, additional training in Japanese cuisine from Tsuji Culinary Institute.",
    asset: true,
  },
  {
    idInstructor: 5,
    ...
    studies:
      "Bachelor's degree in Spanish and French from University of Madrid, certified language instructor.",
    asset: false,
  },
  {
    idInstructor: 6,
    ...
    studies:
      "Bachelor's degree in Music from Berklee College of Music, additional training in classical guitar from Royal Conservatory of Music.",
    asset: true,
  },
  {
    idInstructor: 7,
    ...
    studies:
      "Master's degree in Fine Arts from School of the Art Institute of Chicago, additional training in painting and drawing from Florence Academy of Art.",
    asset: false,
  },
  {
    idInstructor: 8,
    ...
    studies:
      "Bachelor's degree in Computer Science from Stanford University, advanced training in full-stack web development.",
    asset: true,
  },
  {
    idInstructor: 9,
    ...
    studies:
      "Bachelor's degree in Marketing from University of California, Los Angeles, MBA from Harvard Business School.",
    asset: false,
  },
  {
    idInstructor: 10,
    ...
    studies:
      "Bachelor's degree in Photography from New York University, additional training in fashion photography from International Center",
    asset: false,
  },
];
